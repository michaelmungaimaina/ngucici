...
import mich.gwan.ngucici.adapters.pdf.PDFSpare;
import mich.gwan.ngucici.adapters.spare.SpareSaleRecyclerAdapter;
import mich.gwan.ngucici.databinding.ActivitySparesalesListBinding;
...
public class SpareSaleListActivity extends AppCompatActivity implements PDFSpare.OnDocumentClose {
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Ngucici/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_spare.pdf";
        }
        return path;
    }
