...
import mich.gwan.ngucici.adapters.pdf.PDFPowersaw;
import mich.gwan.ngucici.adapters.powersaw.PowersawSaleRecyclerAdapter;
import mich.gwan.ngucici.databinding.ActivityPowersawsalesListBinding;
...
public class PowersawSaleListActivity extends AppCompatActivity implements PDFPowersaw.OnDocumentClose {
    ...
    private  void initViews(){
        ...
        froDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                froDatePickerDialog = new DatePickerDialog(PowersawSaleListActivity.this, R.style.CustomDatePickerDialogTheme, new DatePickerDialog.OnDateSetListener() {
        ...
        toDatePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                toDatePickerDialog = new DatePickerDialog(PowersawSaleListActivity.this, R.style.CustomDatePickerDialogTheme, new DatePickerDialog.OnDateSetListener() {
                    @SuppressLint("SetTextI18n")
                    @Override
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        if (dayOfMonth < 10 ){
    ...
    {
        Toast.makeText(PowersawSaleListActivity.this,"Data processed successfully",Toast.LENGTH_SHORT).show();
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS) + "/"  + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_Powersaw.pdf";
        }
        else
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Ngucici/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_powersaw.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_Ngucici_powersaw_sale_data.xls";
