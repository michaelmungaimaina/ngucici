...
public class PDFPowersaw {

    private static final String TAG   = PDFPowersaw.class.getSimpleName();
    ...
    private static void createTopDataTable(Document doc) throws DocumentException {
        ...
        PdfPCell cell;
        {
            ...
            cell = new PdfPCell(new Phrase("NGUCICI POWERSAW TRANSACTIONS", FONT_MID_TEXT));
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setUseBorderPadding(true);
            cell.setBorder(Rectangle.BOTTOM);
