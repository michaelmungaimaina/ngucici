package mich.gwan.ngucici.activities.admin.ui.gallery;
...
import mich.gwan.ngucici.adapters.AllSale.AllsaleRecyclerAdapter;
import mich.gwan.ngucici.adapters.pdf.PDFUtility;
import mich.gwan.ngucici.databinding.FragmentGalleryBinding;
...
public class GalleryFragment extends Fragment implements PDFUtility.OnDocumentClose {
   ...
   // private void deleteItem(int position) {
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Ngucici/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_AllSales.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_Ngucici_allsale_data.xls";
                    ...
                    if (froDatePicker.getText() == "" && toDatePicker.getText() == ""){
                        ...
                        new AsyncTask<Void, Void, Void>() {
                            ...
                            protected Void doInBackground(@SuppressLint("StaticFieldLeak") Void... params) {
                                ...
                                textNetProfit.setText((String.valueOf(databaseHelper.getAllSaleProfit())));
                                textNetTotal.setText(String.valueOf(databaseHelper.getAllSaleTotal()));
                                return null;
                            }
