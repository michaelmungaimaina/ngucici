...
import mich.gwan.ngucici.adapters.pdf.PDFSpanner;
import mich.gwan.ngucici.adapters.spanner.SpannerSaleRecyclerAdapter;
import mich.gwan.ngucici.databinding.ActivitySpannersalesListBinding;
...
public class SpannerSaleListActivity extends AppCompatActivity implements PDFSpanner.OnDocumentClose {
    ...
    private String path(){
        ...
        {
            path = Environment.getExternalStorageDirectory() + "/Sarensa/Ngucici/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss"))+"_Spanner.pdf";
        }
        return path;
    }
    ...
    public void generateEXCEL(){
        ...
        String filename = m.format(t) + "_Ngucici_spanner_sale_data.xls";
